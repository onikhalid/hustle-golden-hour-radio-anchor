...
export default function LoginPage() {
  ...
  const modalCardClasses =
    "rounded-3xl border border-white/10 bg-white/[0.07] p-8 shadow-[0_40px_120px_-60px_rgba(5,0,20,0.9)] backdrop-blur-xl";
        ...
        <div className={`${modalCardClasses} w-full max-w-lg text-white/90`}>
          <header className="flex flex-col gap-2 pr-16">
            ...
            <p className="text-sm text-white/60">
              Sign in to create and manage your station's questions and question
              categories, spin up live quiz sessions, monitor contestants, and
              crown your winners in real time.
            </p>
          </header>
